...
- [x] 1.1 Implement localized Inquirer choices, parameter/default modes and cancellation; verify isolated prompt and CLI parsing tests.
- [x] 1.2 Add read-only init preflight and complete Git/config/Skills/directory setup with preservation and human summary; verify core and initializer tests.
