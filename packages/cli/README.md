...
The interface follows the user's locale. Use `--lang zh-CN`, `--lang en-US`, or `SPEC_AUTONOMOUS_LANG` and POSIX locale variables. Command names, JSON fields, error codes and MCP tool names remain stable.
