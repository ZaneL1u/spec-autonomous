//#region packages/cli/src/lib/platform.mts
const platforms = [
	{
		key: "darwin-arm64",
	...
	},
	{
		...
		os: "win32",
		cpu: "arm64",
		executable: "spec-autonomous.exe"
	},
	{
		key: "win32-x64",
...
function platformFor(os = process.platform, cpu = process.arch, glibc = runtimeGlibc()) {
